<div>
    ...
    <flux:heading size="xl" align="center">{{ __('auth.reset-password-link.title') }}</flux:heading>

    <div class="mt-10 space-y-6 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <flux:card class="space-y-6">
            <div>
                <flux:heading>{{ __('auth.reset-password-link.heading') }}</flux:heading>
                <flux:subheading>{{ __('auth.reset-password-link.subheading') }}</flux:subheading>
            </div>
            ...
            <div class="flex gap-2">
                ...
                <flux:button wire:click="sendPasswordResetLink" variant="primary">{{ __('auth.reset-password-link.action') }}</flux:button>
            </div>
        </flux:card>
        ...
        <flux:heading align="center">
            {{  __('auth.remember-your-password') }}
